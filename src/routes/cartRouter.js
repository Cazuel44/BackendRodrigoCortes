...
router.post("/api/carts/:cid/products", passport.authenticate('current', { session: false }), checkRole('user'), cartsControllers.addProductToCart); //agregar un producto especifico al carrito
...
router.get("/api/carts/:cid/purchase", cartsControllers.purchaseProducts); // realizar la compra total de los productos del carrito
