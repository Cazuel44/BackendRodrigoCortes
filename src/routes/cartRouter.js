...
router.post("/api/carts/products/:pid", passport.authenticate("current", { session: false }), checkRole(["user", "premium"]), cartsControllers.addProductsToCart);
/* router.post("/api/carts/:cid/products", passport.authenticate("current", { session: false }), checkRole(["user", "premium"]), cartsControllers.addProductsToCart); */ //agregar varios productos al carrito
...
/* router.get("/api/carts/:cid/purchase", passport.authenticate("current", { session: false }), checkRole(["user", "premium"]), cartsControllers.purchaseProducts); */ // realizar la compra total de los productos del carrito
router.get("/api/carts/purchase", passport.authenticate("current", { session: false }), checkRole(["user", "premium"]), cartsControllers.purchaseProducts);
